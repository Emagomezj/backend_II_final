...
userSchema.virtual('carts', {
    ref: 'carts',         // Nombre del modelo de carrito
    localField: '_id',    // Campo del usuario
    foreignField: 'user', // Campo de referencia en el carrito
    justOne: false,       // Especifica false porque un usuario puede tener múltiples carritos
});
